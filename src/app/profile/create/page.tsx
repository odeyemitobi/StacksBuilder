...
import { FiUser, FiGithub, FiGlobe, FiTwitter, FiLinkedin, FiArrowLeft, FiCheck } from 'react-icons/fi';
...
export default function CreateProfilePage() {
      ...
      <Section className="min-h-screen flex items-center justify-center">
        <Card className="p-8 text-center max-w-md">
          ...
          <p className="text-muted-foreground mb-6">
            You need to connect your Stacks wallet to create a developer profile.
          </p>
          <Link href="/">
  ...
  const handleSubmit = async () => {
    ...
    try {
      // TODO: Implement smart contract call to save profile
